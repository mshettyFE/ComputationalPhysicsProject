...
if __name__ == "__main__":
    ...
    print(scales)
#    state, err, initial = NewtonRaphson.NewtonRaphsonWrapper(params,100, 100, 1.2E4)
    state, err, initial = NewtonRaphson.NewtonRaphson(params,100, 100, DataGenMode.PHYSICAL, verbose=True)
