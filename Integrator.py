...
def r_prime_der(current,extra_const_parameters):
    """
        Differential equation for radius
        current: 6x1 numpy array containing the current values for each variable. See Utilities for indices  of current vector
...
def L_prime_der(current, extra_const_params):
    """
        Differential equation for luminosity
        current: 6x1 numpy array containing the current values for each variable. See Utilities for indices  of current vector
        extra_const_parameters: dictionary generated by Utilities.gen_extra_parameters. Not used in all dif. eqs
    """
